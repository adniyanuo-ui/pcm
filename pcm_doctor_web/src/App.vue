...
const selectedFormulaId = ref(formulaCandidates[0].id)
...
const selectedFormula = computed(() => formulaCandidates.find((item) => item.id === selectedFormulaId.value))
        ...
        <Transition name="stage-fade" mode="out-in">
          ...
          <div v-else-if="currentStep === 3" key="formula" class="formula-stage">
            <FormulaPanel
              ...
              :stale="downstreamStale"
              @refresh="refreshEvidence('已重新检索《中医方剂大辞典》')"
