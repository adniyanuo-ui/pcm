	...
	<div class="layout">
		...
		>
			...
			<div class="wrapper">
				...
				>
					<div v-if="(!$store.state.settings.showHeader || $store.state.settings.mode == 'mobile') && ($store.state.menu.routes.length > 1 || $store.state.settings.alwaysShowMainSidebar)"
					...
					>
						<Logo :show-logo="$store.state.menu.routes.length <= 1 && !$store.state.settings.alwaysShowMainSidebar"
							  :class="{
                            'sidebar-logo': true,
						...
						/>
						<el-menu :background-color="variables.g_sub_sidebar_bg"
								 :text-color="variables.g_sub_sidebar_menu_color"
								 :active-text-color="variables.g_sub_sidebar_menu_active_color" unique-opened
...
.wrapper {
    ...
    .main-container {
        ...
        .main {
            ...
            //flex: auto;
            position: relative;
            margin: $g-topbar-height + 20 20px 20px 20px;
            overflow: hidden;
